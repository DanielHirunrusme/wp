...
function initializeModules(){for(var e=document.querySelectorAll("[data-module-init]"),i=0;i<e.length;i++)for(var t,u=e[i],l=u.getAttribute("data-module-init").split(" "),n=0;n<l.length;n++){if(unique)try{t=require("modules/"+l[n])}catch(r){t=!1}else if("pjax-container"!=l[n]&&"settings"!=l[n])try{t=require("modules/"+l[n])}catch(r){t=!1}t&&new t(u)}unique=!1}var unique=!0;module.exports=initializeModules;
...
(function (global){
var $="undefined"!=typeof window?window.$:"undefined"!=typeof global?global.$:null,Velocity=$.velocity=require("velocity-animate"),settings=require("modules/settings"),mousewheel=require("jquery-mousewheel"),throttle=require("modules/throttle"),$window,scrollable=!0,projects=!1,project=!1;module.exports=function(e){function i(){o=$(a.width()<settings.breakpoints.m?"body":$(".main-wrapper .js-Pjax-add").length>0?".main-wrapper article:last-child":".inner-wrapper")}var t=$(e),a=$(window),r=1e3,o=$($(".main-wrapper .js-Pjax-add").length>0?".main-wrapper article-last-child":".inner-wrapper");if(a.on("resize",function(){i()}),i(),$(".active").on("click",function(e){e.preventDefault(),$(".inner-wrapper").stop().animate({scrollTop:0})}),$("body").hasClass("home")?$(".logo-link").addClass("link-disabled"):$(".logo-link").removeClass("link-disabled"),$("body").hasClass("project")&&($(".main-wrapper article:first-child").data("work-num")==$(".main-wrapper article:last-child").data("work-num")?($(".main-wrapper article:first-child").find(".project-information").hide(),$(".main-wrapper article:last-child").find(".project-information").show().css("opacity",1).css("right",0)):$(".main-wrapper article:first-child").hasClass("projects-wrapper")&&o.scrollTop()<$(".work.shown").height()/2&&$(".main-wrapper article:first-child").find(".project-information").hide()),$(".projects-holder").length>0&&$(".projects-holder").addClass("loaded"),($(".remove-article").data("order")==$(".added-article").data("order")||$(".added-article").hasClass("home")&&$(".remove-article").hasClass("studio")||$(".added-article").hasClass("studio")&&$(".remove-article").hasClass("home"))&&$(".fadein").removeClass("fadein").addClass("show"),$(".next-slide").on("click",function(e){e.preventDefault(),$(".inner-wrapper").stop().animate({scrollTop:a.height()})}),t.hasClass("remove-article")){if($("body").addClass("animating"),$(".added-article .fade-in").length&&$(".added-article .fade-in").velocity({opacity:1},{duration:r,easing:"ease-in-out",complete:function(){$(".added-article").addClass("anim-finished"),$("body").removeClass("animating")}}),$(".remove-article .fade-in").velocity({opacity:0},{duration:r,easing:"ease-in-out",complete:function(){$(".added-article").addClass("anim-finished"),$("body").removeClass("animating")}}),$(".main-wrapper .remove-article").find(".post-content").length>0&&$(".main-wrapper .added-article").data("order")!=$(".main-wrapper .remove-article").data("order")&&(settings.scrollPos=settings.padding.top,$(".remove-article .post-content").velocity("stop").velocity({left:-a.width()},{duration:r,easing:"ease-in-out"})),$(".main-wrapper .added-article").data("order")!=$(".main-wrapper .remove-article").data("order")?(settings.scrollPos=settings.padding.top,$(".site-description span:last-child").velocity({left:0},{duration:r,easing:"ease-in-out"}),$(".site-description span:first-child").velocity("stop").velocity({left:-a.width()},{duration:r,easing:"ease-in-out"})):($(".site-description span:last-child").velocity({left:0},{duration:0,easing:"ease-in-out"}),$(".site-description span:first-child").velocity("stop").velocity({left:-a.width()},{duration:0,easing:"ease-in-out"}),$(".remove-article .project-information").velocity({right:a.width()},{duration:r,easing:"ease-in-out",complete:function(){}})),setTimeout(function(){$(".remove-article").remove(),$("body").removeClass("animating")},r),$(".added-article .left-menu").length>0){if($(".main-wrapper .added-article").data("order")!=$(".main-wrapper .remove-article").data("order")){var n=a.width()>settings.breakpoints.m?$(".added-article .left-menu").data("left"):0;$(".added-article .left-menu").velocity({left:n},{duration:r,easing:"ease-in-out"}),$(".remove-article .project-information").velocity({right:a.width()},{duration:r,easing:"ease-in-out",complete:function(){}})}else{var n=a.width()>settings.breakpoints.m?$(".added-article .left-menu").data("left"):0;$(".added-article .left-menu").velocity({left:n},{duration:0}),$(".remove-article .left-menu").remove()}$(".added-article .project-information").velocity({right:"0"},{duration:r,easing:"ease-in-out",complete:function(){}})}$(".remove-article .left-menu").length>0&&($(".main-wrapper .added-article").data("order")!=$(".main-wrapper .remove-article").data("order")?($(".remove-article .left-menu").velocity({left:"-60vw"},{duration:r,easing:"ease-in-out"}),$(".remove-article .project-information").velocity({right:a.width()},{duration:r,easing:"ease-in-out",complete:function(){}})):$(".remove-article .left-menu").remove()),a.on("resize",function(){setTimeout(function(){if(!$("body").hasClass("animating"))if(a.width()>settings.breakpoints.m){var e=$(".added-article .left-menu").data("left");$(".added-article .left-menu").velocity({left:e},{duration:0,easing:"ease-in-out"})}else $(".added-article .left-menu").velocity({left:0},{duration:0,easing:"ease-in-out"})},100)})}};
...
var settings=require("modules/settings"),mousewheel=require("jquery-mousewheel"),throttle=require("modules/throttle"),$window,scrollable=!0,projects=!1,project=!1;module.exports=function(e){var t=$(".main-wrapper .js-Pjax-add").length>0?$(".main-wrapper .js-Pjax-add"):$(".inner-wrapper"),a=$(window);$("body").hasClass("projects")&&($(".projects-menu nav li").eq(0).find("a").addClass("selected"),$(".project-information a").attr("href",$(".projects-menu nav li").eq(0).find("a").attr("href")),$(".project-information h1").text($(".work").eq(0).data("title"))),a.on("mousewheel scroll",throttle(function(e){$("body").hasClass("projects")&&$(".main-wrapper article:last-child").find(".work.on").each(function(){a.width()>settings.breakpoints.m?$(this).position().top<a.height()/2&&($(".main-wrapper article:last-child").find(".project-information h1").text($(this).data("title")),$(".main-wrapper article:last-child").find(".projects-menu nav a").removeClass("selected"),$(".main-wrapper article:last-child").find(".projects-menu nav li").eq($(this).index()).find("a").addClass("selected"),$(".main-wrapper article:last-child").find(".project-information a").attr("href",$(".main-wrapper article:last-child").find(".projects-menu nav li").eq($(this).index()-1).find("a").attr("href")),$(".main-wrapper article:last-child").attr("data-work-num",$(".projects-menu nav li").eq($(this).index()-1).data("num")),$(".main-wrapper article:last-child").find(".project-information a").attr("data-work-num",$(".projects-menu nav li").eq($(this).index()-1).data("num"))):a.width()>settings.breakpoints.m?$(this).position().top<a.height()/4&&($(".main-wrapper article:last-child").find(".project-information h1").text($(this).data("title")),$(".main-wrapper article:last-child").find(".projects-menu nav a").removeClass("selected"),$(".projects-menu nav li").eq($(this).index()).find("a").addClass("selected"),$(".project-information a").attr("href",$(".projects-menu nav li").eq($(this).index()).find("a").attr("href")),$(".project-information a").data("num",$(".projects-menu nav li").eq($(this).index()).data("num"))):$("body").scrollTop()>$(this).position().top-a.height()/2&&($(".main-wrapper article:last-child").find(".project-information h1").text($(this).data("title")),$(".main-wrapper article:last-child").find(".projects-menu nav a").removeClass("selected"),$(".projects-menu nav li").eq($(this).index()).find("a").addClass("selected"),$(".main-wrapper article:last-child").find(".project-information a").data("num",222),$(".main-wrapper article:last-child").find(".project-information a").attr("data-work-num",$(".projects-menu nav li").eq($(this).index()-1).data("num")),$(".main-wrapper article:last-child").find(".project-information a").attr("href",$(".main-wrapper article:last-child").find(".projects-menu nav li").eq($(this).index()-1).find("a").attr("href")))})},200)),a.on("mousewheel scroll",function(){if($("body").hasClass("project")){var e=1-(t.scrollTop()-a.height()/2)/a.height(),i=t;a.width()>settings.breakpoints.m?($(".projects-menu").addClass("notrans"),$(".projects-menu").css("opacity",e),$(".project-information").css("opacity",1),$(".main-menu").css("opacity",e),.3>e?($(".projects-menu").addClass("disable-link"),$(".main-menu").addClass("disable-link")):($(".projects-menu").removeClass("disable-link"),$(".main-menu").removeClass("disable-link"))):i=$("body");var r=-1*(i.scrollTop()-i[0].scrollHeight+a.height())/a.height();r=r>1?1:r,r=0>r?0:r;var n=10*i.scrollTop()/a.height();if(n=n>1?1:n,n=0>n?0:n,n=1-n,i[0].scrollHeight<=2*a.height()){if(r=1,n=0,$("body").hasClass("scrolling"))return!0;.5>r?($(".project-information .inner").hide(),$(".top").hasClass("off")||$(".top").show().css("opacity",1)):($(".project-information .inner").show(),$(".top").hide().css("opacity",0))}else{if($("body").hasClass("scrolling"))return!0;.5>r?($(".project-information .inner").hide(),$(".top").show().css("opacity",1),$(".top").removeClass("off")):($(".project-information .inner").show(),$(".top").hide().css("opacity",0),$(".top").addClass("off"))}}}),$(".projects-menu").on("mouseover",function(){scrollable=!1,$("body").addClass("menu-over")}).on("mouseout",function(){scrollable=!0,$("body").removeClass("menu-over")}),a.on("mousewheel",function(e){if($("body").hasClass("mobile"))return!0;if($("body").hasClass("animating")||$("body").hasClass("toggle-menu")||!scrollable)return!0;var a=t.scrollTop();return t.scrollTop(a-e.deltaY),!0}),a.trigger("mousewheel"),a.trigger("resize")};
...
function getURLParameter(e){return decodeURIComponent((new RegExp("[?|&]"+e+"=([^&;]+?)(&|#|;|$)").exec(location.search)||[,""])[1].replace(/\+/g,"%20"))||null}function changeUrlParam(e,t){var o=window.location.href+"&",i=new RegExp("("+e+")=(.*)&","g"),a=o.replace(i,"$1="+t+"&");if(null!==getURLParameter(e))try{window.history.replaceState("","",a.slice(0,-1))}catch(r){}else{var n=window.location.href;-1!==n.indexOf("?")?window.history.replaceState("","",o.slice(0,-1)+"&"+e+"="+t):window.history.replaceState("","",o.slice(0,-1)+"?"+e+"="+t)}}var settings=require("modules/settings"),controller=require("modules/section-controller"),velocity=require("velocity-animate/velocity");module.exports=function(e){function t(e){var t=e;$(".categories .on").removeClass("on"),$(".categories li").eq(t).find("a").addClass("on"),$(".categories").addClass("filtered"),$(".project-list li.on").removeClass("on");var o=$window.width()>settings.breakpoints.m?.04*$window.height():0;$(".projects-menu").stop().velocity({top:o},{duration:r,easing:"ease-in-out",complete:function(){}}),$(".work").removeClass("on");for(var i=0;i<sorted[t].length;i++){var a=sorted[t][i].id;$(".project-list li").eq(a).addClass("filtered on").stop().slideDown();$(".project-list li").eq(a).index();$("body").hasClass("projects")&&$(".work").eq(a).addClass("on").show().velocity({height:$window.height()},{duration:400,easing:"ease-in-out"})}if($(".project-list a").each(function(){var e=void 0!=$(".categories a.on").data("category")?$(".categories a.on").data("category"):getURLParameter("category"),t=hrefs[$(this).parent().index()];t=t.split("?")[0],t=t+"?category="+e;var o=$(this).attr("href").split("?")[0];o=o+"?category="+e,$(this).attr("href",o)}),$(".project-list li").each(function(){$(this).hasClass("on")||$(this).stop().slideUp()}),!$("body").hasClass("project")){var r=unique?0:400;$(".inner-wrapper").stop().animate({scrollTop:0},400),$(".work").each(function(){$(this).hasClass("on")||$(this).show().velocity({height:0},{duration:r,easing:"ease-in-out",complete:function(){$(this).hide(),$window.trigger("mousewheel")}})})}}var o=$(e);$window=$(window),sorted=[],unique=!0,hrefs=[];var i=0;if($project_menu=o.closest(".projects-menu"),o.find("a").each(function(){var e=String($(this).data("category"));sorted[i]=[];for(var t=0;t<$project_menu.find("li").length;t++){var o=$project_menu.find("li").eq(t).find("a").data("categories");void 0!=o&&o.indexOf(e)>=0&&sorted[i].push({id:t,name:$project_menu.find("li").eq(t).find("a").text()})}i++}),$(".project-list a").each(function(){hrefs.push($(this).attr("href"))}),null!=getURLParameter("category")){getURLParameter("category")}o.find("a").on("mouseover",function(e){for(var t=$(this).parent().index(),o=0;o<sorted[t].length;o++){var i=sorted[t][o].id;$project_menu.find("li").eq(i).addClass("over")}}).on("mouseout",function(e){for(var t=$(this).parent().index(),o=0;o<sorted[t];o++);$project_menu.find("li.over").removeClass("over")}).on("click",function(e){e.preventDefault(),$(this).hasClass("on")?$(".inner-wrapper").stop().animate({scrollTop:0},400):("all"!=$(this).data("category")?t($(this).parent().index()):($(".project-list a").each(function(){var e="all",t=hrefs[$(this).parent().index()];t=t.split("?")[0],t=t+"?category="+e,$(this).attr("href",t)}),$(".categories").removeClass("filtered"),$(".categories .on").removeClass("on"),$(this).addClass("on"),$project_menu.find("li").removeClass("filtered on").stop().slideDown(),$("body").hasClass("project")||$(".work").addClass("on").show().velocity({height:$window.height()},{duration:400,easing:"ease-in-out"})),changeUrlParam("category",$(this).data("category")))}),unique=!1};
...
var settings=require("modules/settings"),controller=require("modules/section-controller");module.exports=function(t){var i=$(t);$window=$(window),opacity=1,disabled=!1,area=i.data("scroll-area"),bounds="all"==area?$window.width():$window.width()/2,i.find("a").on("click",function(){$(".project-list").addClass("active"),$(this).closest("ul").addClass("active"),$(this).closest("ul").find("a.active").removeClass("active"),$(this).addClass("active")}).on("mouseover",function(){i.addClass("over")}).on("mouseout",function(){}),$(settings.scrollContainer).on("mousewheel scroll",function(t){if(i.height()>$window.height()&&$window.width()>settings.breakpoints.m&&t.clientX<bounds){var o=.04*$window.height();if(t.deltaY>0){var s=i.position().top-t.deltaY>$window.height()-i.height()-o?i.position().top-t.deltaY:$window.height()-i.height()-o;i.css("top",s),settings.scrollPos=s}else{var s=i.position().top-t.deltaY<o?i.position().top-t.deltaY:o;i.css("top",s),settings.scrollPos=s}}}),i.css("top",settings.scrollPos),$window.on("resize",function(){if(i.height()<$window.height()&&$window.width()>settings.breakpoints.m){var t=.04*$window.height();i.css("top",t)}})};
},{"modules/section-controller":"modules/section-controller","modules/settings":"modules/settings"}],"modules/pjax-container":[function(require,module,exports){
var initializeModules=require("../lib/init-modules.js"),settings=require("modules/settings"),velocity=require("velocity-animate");module.exports=function(e){function i(){setTimeout(function(){$(".waiting").removeClass("visible"),$("*").removeClass("notrans")},1e3),settings.unique=!1,$("body").removeClass().addClass($(".main-menu").data("page")),$("body *").addClass("notrans"),initializeModules()}function a(){$(".waiting").addClass("visible"),t.off("mousewheel")}var t=($(e),$(window));new Pjax({elements:"a.pjax",selectors:["title",".main-menu",".main-wrapper",".pjax-container",".site-footer"],switches:{".main-wrapper":Pjax.switches.sideBySide,".pjax-container":Pjax.switches.sideBySide},switchesOptions:{".main-wrapper":{classNames:{remove:"remove-article",add:"added-article",backward:"Animate--slideInRight",forward:"Animate--slideInLeft"}},".pjax-container":{classNames:{remove:"remove-article",add:"added-article",backward:"Animate--slideInRight",forward:"Animate--slideInLeft"}}},analytics:function(){window.ga("send","pageview",{page:document.location.pathname,title:document.title})}}),t.width()<settings.breakpoints.m&&$("html, body").animate({scrollTop:1},0),document.addEventListener("pjax:success",i),$(document).on("pjax:send",a)};
...
(function (global){
var $="undefined"!=typeof window?window.$:"undefined"!=typeof global?global.$:null,Velocity=$.velocity=require("velocity-animate"),settings=require("modules/settings"),controller=require("modules/section-controller");module.exports=function(e){var i=$(e);$window=$(window);i.parent().index();i.on("mouseover",function(e){if(e.stopPropagation(),$window.width()<settings.breakpoints.m)return!0;var o=i.parent().index();i.hasClass("main-wrapper")||$(".preview-bg").eq(o).velocity("stop").velocity({opacity:1},{duration:400,easing:"ease-in-out"})}).on("mouseout",function(e){if(e.stopPropagation(),settings.breakpoints.m<1e3)return!0;var o=i.parent().index();$(".preview-bg").eq(o).velocity("stop").velocity({opacity:e},{duration:800,easing:"ease-in-out"})}).on("click",function(e){$(this).closest("ul").find(".active").removeClass("active"),$(this).addClass("active")})};
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
...
function setPage(e){settings.page.current=e}function getPage(){return settings.page.current}function loadPage(e){}var settings=require("modules/settings"),$window,page="",resizeTimer;module.loadPage=function(e){},module.exports=function(e){var n=$(e);$window=$(window),setPage(n.data("section")),$('section[data-section="'+getPage()+'"]').addClass("visible"),$window.on("resize",function(){$("a, p, section, div, span, ul").addClass("notransition"),clearTimeout(resizeTimer),resizeTimer=setTimeout(function(){$("a, p, section, div, span, ul").removeClass("notransition")},200)})};
},{"modules/settings":"modules/settings"}],"modules/section":[function(require,module,exports){
var settings=require("modules/settings"),controller=require("modules/section-controller"),$window;module.exports=function(e){$(e);$window=$(window),settings.unique||settings.animating||(settings.animating=!0,$(".js-Pjax-add").data("tier")==$(".js-Pjax-remove").data("tier")&&(Number($(".js-Pjax-add").data("page-id"))>Number($(".js-Pjax-remove").data("page-id"))?($(".js-Pjax-add").velocity({left:-$window.width()},0).velocity({left:0},1e3,"ease-in-out"),$(".js-Pjax-remove").velocity({left:$window.width()},{duration:1e3,easing:"ease-in-out",complete:function(){$(".js-Pjax-remove").remove()}}),$(".logos").velocity({left:0},0).velocity({left:$window.width()},1e3,"ease-in-out")):($(".js-Pjax-add").velocity({left:$window.width()},0).velocity({left:0},1e3,"ease-in-out"),$(".js-Pjax-remove").velocity({left:-$window.width()},{duration:1e3,easing:"ease-in-out",complete:function(){$(".js-Pjax-remove").remove()}}),$(".logos").velocity({left:0},0).velocity({left:-$window.width()},1e3,"ease-in-out"))),$(".js-Pjax-add").data("tier")>$(".js-Pjax-remove").data("tier")&&($(".js-Pjax-add").velocity({top:$window.width()},0).velocity({top:0},1e3,"ease-in-out"),$(".js-Pjax-remove").velocity({top:-$window.width()},{duration:1e3,easing:"ease-in-out",complete:function(){$(".js-Pjax-remove").remove()}})),$(".js-Pjax-add").data("tier")<$(".js-Pjax-remove").data("tier")&&($(".js-Pjax-add").velocity({top:-$window.width()},0).velocity({top:0},1e3,"ease-in-out"),$(".js-Pjax-remove").velocity({top:$window.width()},{duration:1e3,easing:"ease-in-out",complete:function(){$(".js-Pjax-remove").remove()}})),setTimeout(function(){settings.animating=!1},1e3)),$window.on("resize",function(){$(".screen-0").css("left",-$window.width()),$(".screen-1").css("left",0),$(".screen-2").css("left",$window.width()),$(".screen-3").css("left",2*$window.width()),$(".logos").css("left",0),0==settings.animating}),$window.trigger("resize")};
...
var settings=require("modules/settings"),controller=require("modules/section-controller"),velocity=require("velocity-animate/velocity");module.exports=function(e){var i=$(e);$window=$(window);var o=i.data("video-bg"),r=(i.data("work-id"),i.parent().find(".preview-image"));i.YTPlayer({fitToBackground:!0,videoId:o,playerVars:{modestbranding:0,autoplay:0,controls:0,showinfo:0,branding:0,imagePreview:r,rel:0,autohide:0,start:59,origin:window.location.origin}})};
...
var settings=require("modules/settings"),controller=require("modules/section-controller"),velocity=require("velocity-animate/velocity");module.exports=function(i){function e(i){$f(i).api("setVolume",0)}function n(){var i=$window.width(),e=$window.height(),n=i,t=e+5625*n,o=(-n/2+$window.width()/2,-t/2+$window.height()/2);d.css("width",n+"px").css("height",t+"px").css("margin-top",o)}function t(){$window.width()<settings.breakpoints.m?(h=$("body"),o.find(".lazy").lazyload({effect:"fadeIn",threshold:$window.height()})):(h=$(".main-wrapper .js-Pjax-add").length>0?$(".main-wrapper .js-Pjax-add"):$(".inner-wrapper"),o.find(".lazy").lazyload({container:h,effect:"fadeIn",threshold:$window.height()}))}var o=$(i);if($window=$(window),2==o.index()&&!settings.unique&&$("body").hasClass("project")&&($("body").addClass("animating"),setTimeout(function(){$("body").removeClass("animating")},500)),o.hasClass("vimeo")&&("0"==o.data("muted")&&$("iframe.vimeoplayer").each(function(){$f(this).addEvent("ready",e)}),"1"==o.data("fullscreen"))){var d=($(".embed-container"),$(".vimeo"));window.addEventListener("resize",n,!1),n()}$window.on("resize",function(i){$window.width()>settings.breakpoints.m?(o.css("height",$window.height()),o.find(".work-holder").css("height",$window.height())):$("body").hasClass("project")?$window.width()>$window.height()?(o.css("height",$window.height()),o.find(".work-holder").css("height",$window.height())):(o.css("height",$window.height()/2),o.find(".work-holder").css("height",$window.height()/2)):(o.css("height",$window.height()),o.find(".work-holder").css("height",$window.height()))});var h=$(".main-wrapper .js-Pjax-add").length>0?$(".main-wrapper .js-Pjax-add"):$(".inner-wrapper");$window.on("resize",function(){t()}),t()};
